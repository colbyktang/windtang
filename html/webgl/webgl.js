...
function main() {
    console.log("Starting up WebGL Canvas...");
...
function initBuffers(gl) {
    ...
    */
    ...
    var colors = [
        ...
        0.0, 1.0, 1.0, 1.0,     // cyan
        1.0, 1.0, 0.0, 1.0,     // yellow 5
        1.0, 0.0, 0.0, 1.0,     // red
        0.0, 1.0, 1.0, 1.0,     // cyan 7
        1.0, 1.0, 0.0, 1.0,     // yellow
        1.0, 0.0, 1.0, 1.0,     // magenta 9
        0.0, 1.0, 0.0, 1.0,     // green 10
        0.0, 0.0, 1.0, 1.0,     // blue 11
        1.0, 1.0, 1.0, 1.0,     // white 12
        1.0, 0.5, 0.0, 1.0,     // orange? 13
        0.98, 0.502, 0.447, 1.0,     // salmon? 14
        0.98, 0.502, 0.447, 1.0,     // salmon? 15
        0.98, 0.502, 0.447, 1.0,     // salmon? 16
        0.98, 0.502, 0.447, 1.0,     // salmon? 17
    ];
    */
    ...
    // using the indices into the vertex array
...
function drawScene (gl, programInfo, buffers, deltaTime) {
    ...
    // Our field of view is 45 degrees, with a width/height ratio
    // that matches the display size of the canvas
    // and we only want to see objects between 0.1 units and
